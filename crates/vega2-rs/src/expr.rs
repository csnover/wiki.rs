...
use libphp_rs::{DateTime, DateTimeError, DateTimeZone, floatval, intval, strtr};
use rand::Rng as _;
...
const FUNCTIONS: phf::Map<&'static str, &'static dyn Callable> = phf::phf_map! {
    ...
    "date" => &wrap_date::<false, _, _>(DateTime::day),
    "day" => &wrap_date::<false, _, _>(|date| date.weekday() as u8),
    "year" => &wrap_date::<false, _, _>(DateTime::year),
    "month" => &wrap_date::<false, _, _>(|v| v.month() as u8 - 1),
    "hours" => &wrap_date::<false, _, _>(DateTime::hour),
    "minutes" => &wrap_date::<false, _, _>(DateTime::minute),
    "seconds" => &wrap_date::<false, _, _>(DateTime::second),
    "milliseconds" => &wrap_date::<false, _, _>(DateTime::millisecond),
    ...
    "utcdate" => &wrap_date::<true, _, _>(DateTime::day),
    "utcday" => &wrap_date::<true, _, _>(|date| date.weekday() as u8),
    "utcyear" => &wrap_date::<true, _, _>(DateTime::year),
    "utcmonth" => &wrap_date::<true, _, _>(|v| v.month() as u8 - 1),
    "utchours" => &wrap_date::<true, _, _>(DateTime::hour),
    "utcminutes" => &wrap_date::<true, _, _>(DateTime::minute),
    "utcseconds" => &wrap_date::<true, _, _>(DateTime::second),
    "utcmilliseconds" => &wrap_date::<true, _, _>(DateTime::millisecond),
