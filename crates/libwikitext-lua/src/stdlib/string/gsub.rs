...
/// * `repl` is an invalid type
/// * `repl` is a string and it contains an invalid replacement sequence
/// * `repl` is a function and it raises an error when it is called
/// * `repl` is a table or function and it returns an invalid type
